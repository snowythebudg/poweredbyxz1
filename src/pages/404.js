...
export default (() => {
	return <Theme theme={theme}>
		...
		<Helmet>
			...
			<meta name={"description"} content={"Looks like someone's in the wrong spot!"} />
			<meta property={"og:title"} content={"Powered by XZ1 - 404"} />
			<meta property={"og:description"} content={"Looks like someone's in the wrong spot!"} />
		...
		>
			...
			<Box align-items="center" display="flex" justify-content="center" flex-direction="column">
				...
				>
					Looks like someone managed to literally break the fourth wall. Click "Back to home" to head back to the safe zone!
				</Text>
				<LinkBox
					flex-direction="row"
